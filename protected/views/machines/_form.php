...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="form-group">
		...
		<?php echo $form->textField($model,'industry',array('class'=>'form-control','size'=>45,'maxlength'=>45)); ?>
		<?php echo $form->error($model,'industry'); ?>
	</div>

	<div class="form-group">
		<?php echo $form->labelEx($model,'code'); ?>
		<?php echo $form->textField($model,'code',array('class'=>'form-control','size'=>60,'maxlength'=>64)); ?>
